...
const translations = {
  en: {
    ...
    'nav-progress': 'Progress', 'nav-plans': 'Study Plans', 'nav-favorites': 'Favorites', 'nav-support': 'Support',
    ...
    'open-library': 'Open Library', 'no-tickets-title': 'Need help?',
    'no-tickets-desc': "Contact support and we'll help you with your issue.", 'contact-support': 'Contact Support',
  ...
  fr: {
    ...
    'nav-progress': 'Progrès', 'nav-plans': 'Plans d\'étude', 'nav-favorites': 'Favoris', 'nav-support': 'Support',
    ...
    'open-library': 'Ouvrir la bibliothèque', 'no-tickets-title': "Besoin d'aide ?",
    'no-tickets-desc': 'Contactez le support et nous vous aiderons.', 'contact-support': 'Contacter le support',
  ...
  ar: {
    ...
    'nav-progress': 'التقدم', 'nav-plans': 'خطط الدراسة', 'nav-favorites': 'المفضلة', 'nav-support': 'الدعم',
    ...
    'open-library': 'افتح المكتبة', 'no-tickets-title': 'تحتاج مساعدة؟',
    'no-tickets-desc': 'تواصل مع الدعم وسنساعدك في مشكلتك.', 'contact-support': 'تواصل مع الدعم',
