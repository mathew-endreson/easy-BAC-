...
const translations = {
  en: {
    ...
    'continue': 'Continue', retry: 'Retry', close: 'Close', 'open-menu': 'Open menu', 'sign-out': 'Sign out',
    ...
    'nav-profile': 'Profile', 'switch-to-admin': 'Switch to Admin Dashboard', 'view-full-progress': 'View full progress',
    'avg-score': 'Average score', 'flashcards-reviewed': 'Flashcards reviewed', 'study-time': 'Study time',
    'quick-stats': 'Quick stats', 'account-details': 'Account details', 'member-since': 'Member since',
    ...
    previous: 'Previous', next: 'Next', finish: 'Finish', restart: 'Restart',
    'choose-correct-answer': 'Choose the correct answer', 'start-learning': 'Start Learning',
    'quiz-finished': 'Quiz Finished!', 'perfect-score-msg': 'Perfect score! You are ready for the BAC.',
    'good-job-msg': 'Good job! Keep practicing to improve your score.',
    'back-to-decks': 'Back to Decks', 'no-quizzes-found': 'No quizzes found for {subject}',
    'no-cards-found': 'No cards for {subject}', 'fetching-quiz': 'Fetching quiz…',
  ...
  fr: {
    ...
    'continue': 'Continuer', retry: 'Réessayer', close: 'Fermer', 'open-menu': 'Ouvrir le menu', 'sign-out': 'Se déconnecter',
    ...
    'nav-profile': 'Profil', 'switch-to-admin': "Passer au tableau de bord Admin", 'view-full-progress': 'Voir la progression complète',
    'avg-score': 'Score moyen', 'flashcards-reviewed': 'Fiches révisées', 'study-time': "Temps d'étude",
    'quick-stats': 'Statistiques rapides', 'account-details': 'Détails du compte', 'member-since': 'Membre depuis',
    ...
    favorites: 'Favoris',
    previous: 'Précédent', next: 'Suivant', finish: 'Terminer', restart: 'Recommencer',
    'choose-correct-answer': 'Choisissez la bonne réponse', 'start-learning': 'Commencer',
    'quiz-finished': 'Quiz terminé !', 'perfect-score-msg': 'Score parfait ! Vous êtes prêt pour le BAC.',
    'good-job-msg': 'Bon travail ! Continuez à vous entraîner pour améliorer votre score.',
    'back-to-decks': 'Retour aux paquets', 'no-quizzes-found': 'Aucun quiz trouvé pour {subject}',
    'no-cards-found': 'Aucune carte pour {subject}', 'fetching-quiz': 'Récupération du quiz…',
  ...
  ar: {
    ...
    'continue': 'متابعة', retry: 'إعادة المحاولة', close: 'إغلاق', 'open-menu': 'فتح القائمة', 'sign-out': 'تسجيل الخروج',
    ...
    'nav-profile': 'الملف الشخصي', 'switch-to-admin': 'التبديل إلى لوحة تحكم الإدارة', 'view-full-progress': 'عرض التقدم الكامل',
    'avg-score': 'المعدل', 'flashcards-reviewed': 'البطاقات المُراجعة', 'study-time': 'وقت الدراسة',
    'quick-stats': 'إحصائيات سريعة', 'account-details': 'تفاصيل الحساب', 'member-since': 'عضو منذ',
    ...
    favorites: 'المفضلة',
    previous: 'السابق', next: 'التالي', finish: 'إنهاء', restart: 'إعادة البدء',
    'choose-correct-answer': 'اختر الإجابة الصحيحة', 'start-learning': 'ابدأ التعلم',
    'quiz-finished': 'انتهى الاختبار!', 'perfect-score-msg': 'نتيجة كاملة! أنت جاهز للبكالوريا.',
    'good-job-msg': 'أحسنت! واصل التدرب لتحسين نتيجتك.',
    'back-to-decks': 'العودة إلى المجموعات', 'no-quizzes-found': 'لا توجد اختبارات لـ {subject}',
    'no-cards-found': 'لا توجد بطاقات لـ {subject}', 'fetching-quiz': 'جارٍ تحميل الاختبار…',
